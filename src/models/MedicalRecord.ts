...
MedicalRecordSchema.index({ tenant_id: 1, patient_id: 1, visit_date: -1 });
MedicalRecordSchema.index({ tenant_id: 1, doctor_id: 1, visit_date: -1 });
MedicalRecordSchema.index({ tenant_id: 1, visit_date: -1 });
